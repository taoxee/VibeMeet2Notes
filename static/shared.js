...
const i18n = {
  zh: {
    ...
    noAsrVendor: "暂无已配置的 ASR 供应商，请先在供应商页面配置凭证",
    noLlmVendor: "暂无已配置的 LLM 供应商，请先在供应商页面配置凭证",
    startBtn: "开始处理",
    queueTitle: "任务队列",
    queueCollapse: "▲ 收起",
    queueExpand: "▼ 展开",
    ...
    fwCompatSafari: "Safari: macOS 15.2+ 部分支持，每次启动需重新授权",
  ...
  en: {
    ...
    noAsrVendor: "No ASR vendor configured. Please add credentials on the Vendors page.",
    noLlmVendor: "No LLM vendor configured. Please add credentials on the Vendors page.",
    ...
    cleared: "All credentials cleared",
    ...
    fwCompatSafari: "Safari: macOS 15.2+ partial, re-auth each session",
